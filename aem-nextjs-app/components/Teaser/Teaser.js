/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 import { Hero, Relationframe, Button, Heading, LinkGroup, WhichButton } from '@zendesk/greenhouse';
 ...
 <Hero
            ...
            contentSide={
            <Relationframe shape="square">
                <img alt="flowers" src={props.imagePath }/>
            </Relationframe>}
            contentUnderText={<LinkGroup><WhichButton href="#">Click button</WhichButton><WhichButton href="#" variant="secondary">Click button</WhichButton></LinkGroup>}
 ...
 export default MapTo("wknd/components/teaser")(
   EditableCustom
 );